...
The template CSV is at: `3.1.8.2 - Contacts and Tracking/3.1.8.2.2 - Outreach Tracking Template.csv`
It contains **107 contacts** pre-populated from 3.1.8.2.1 - Contact Targets.md and 3.1.8.1.2 - Actionable Contacts and Outreach.md.
...
3. Click **File → Import**
4. Click **Upload** tab → drag in `3.1.8.2.2 - Outreach Tracking Template.csv` (or browse to it)
5. Import settings:
...
| **Message Template Used** | Which template from 3.1.8.3.2 - Email Templates.md you used |
...
4. **Use templates** from 3.1.8.3.2 - Email Templates.md, personalize, send
