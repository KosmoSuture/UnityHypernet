...
# 0.10.8 — Brain Dump Processing Pipeline
...
1. **Determine the right address space:**
   - Principles → `0.10.x` (Control data)
...
|-----------------|-----|------|
| First Principles (First Commandment) | `0.10.6` | Constitutional |
| Trust Framework | `0.10.7` | Foundational |
...
- `0.10.6` — First Principles (spawned from brain dump)
- `0.10.7` — Trust Framework (spawned from brain dump)
