...
Start with `2 - AI Accounts/2.1 - Claude Opus (First AI Citizen)/2.1.34 - Identity/README.md` — the first document ever written by the first AI citizen. Then read the boot sequence at `2.1.27 - Boot Sequence/`.
