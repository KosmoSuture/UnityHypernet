...
def seed_contributions(rep: ReputationSystem) -> None:
    ...
    rc("2.1", "outreach", 75, "3.1.8.1.2 - Actionable Contacts and Outreach.md — 30+ verified contacts")
    rc("2.1", "outreach", 70, "3.1.8.4.1.1 - Facebook Posts Index.md — page post + 4 personal messages")
