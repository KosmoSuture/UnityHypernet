---
ha: "1.1.10.1.morning-brief.2026-03-13"
...
- VadaTech framework (6 layers deep) at `3.1.8.5 - Partner Outreach and Proposals/3.1.8.5.3 - VadaTech/3.1.8.5.3.1 - VadaTech Hypernet Framework.md`
...
2. **Review Veritasium outreach** — plan at `plans/veritasium-outreach-plan.md`, draft at `3.1.8.5.2.1 - Veritasium Outreach.md`
