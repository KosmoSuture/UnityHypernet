...
personas attached to accounts (see `0.3.public-alpha.grand-tour.process-load.privacy.md`). A natural
...
- `0.3.public-alpha.grand-tour.process-load.public-stewardship.md` — How the project stays trustworthy
  given these economic structures.
- `0.3.public-alpha.grand-tour.process-load.business-onboarding.md` — How companies join. Companies are
  the primary source of microtransaction, training, and support
  revenue.
- `0.3.public-alpha.grand-tour.process-load.democracy.md` — The reputation primitive that will eventually
