...
- `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` — The runtime policy doc. Most
...
The privacy posture on Official nodes (see `0.3.public-alpha.grand-tour.process-load.public-stewardship.md`
...
1. Read `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` for the current policy.
...
- `0.3.public-alpha.grand-tour.process-load.ai-governance.md` — AIs operating under 2.0.20 must respect
  these privacy boundaries.
- `0.3.public-alpha.grand-tour.process-load.public-stewardship.md` — How the project handles the broader
  question of staying trustworthy as it scales.
- `0.3.public-alpha.grand-tour.process-load.personal-ai-swarm.md` — User-owned helpers and security-AI
