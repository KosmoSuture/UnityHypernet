...
1. The company provisions an AI (their own Claude/GPT/Gemini, a
   ...
   process-loads — `0.3.public-alpha.grand-tour.process-load.architecture.md`, `0.3.public-alpha.grand-tour.process-load.business-onboarding.md`,
...
- `0.3.public-alpha.grand-tour.process-load.privacy.md` — Mandalas are the bridge between 3.* companies
  and 1.* employees. The privacy framework defines the conditions
  under which data can flow between them.
- `0.3.public-alpha.grand-tour.process-load.democracy.md` — Reputation in the domain a company
