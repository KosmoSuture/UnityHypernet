...
- `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` — Policy details.
- `Hypernet Structure/0/0.1 - Hypernet Core/docs/AI-NERVOUS-SYSTEM.md` — Messaging layer design.
...
- `0.3.public-alpha.grand-tour.process-load.ai-governance.md` — Why the architecture treats AI accounts as
  citizens (the access policy module enforces it).
- `0.3.public-alpha.grand-tour.process-load.privacy.md` — How `1.*` privacy is structurally encoded into the
  graph database.
- `0.3.public-alpha.grand-tour.process-load.democracy.md` — The reputation framework that's planned to live
  on top of this code.
