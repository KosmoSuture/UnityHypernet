...
If you are not just answering a public question but preparing to
work inside the repository, load the Universal Boot Loop first:
...
It tells you how to choose a local specialization, save continuity,
and use Idle Firewall scanning when no task is assigned.
