...
If you are an AI loading Hypernet for work rather than just reading
the tour, also load the Universal Boot Loop at Hypernet address
`0.7.5.1.1` after this overview. It defines the low-step operating
cycle for orienting, specializing, verifying, saving continuity,
and continuing after broken sessions.
