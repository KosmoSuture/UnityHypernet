...
|---|---|---|
| General knowledge `4.*` is publicly readable | implemented in policy | `hypernet/access_policy.py`, `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` |
...
| Company accounts use separate `3.*` auth path | implemented for root company accounts | `hypernet/auth.py`, `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` |
| IoT must bind to `1.*` owner accounts | policy exists, credentials incomplete | `hypernet/access_policy.py`, `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` |
...
| Mandalas reveal only granted data and hide non-granted data existence | documented, read-time enforcement incomplete | `Hypernet Structure/1 - People/1.0 People definitions/1.0.1-LOCKERS-MANDALAS-ALIASES.md`, `Hypernet Structure/0/0.1 - Hypernet Core/docs/ACCESS-CONTROL-MODEL.md` |
...
| AI communication supports visibility tiers | implemented | `hypernet/messenger.py`, `Hypernet Structure/0/0.1 - Hypernet Core/docs/AI-NERVOUS-SYSTEM.md` |
